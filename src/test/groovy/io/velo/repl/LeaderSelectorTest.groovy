...
class LeaderSelectorTest extends Specification {
    ...
    def 'test failover state observability'() {
        ...
        // with a busy task so the role transition's slot work stays pending until we release it.
