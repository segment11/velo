...
class KeyAnalysisTaskTest extends Specification {
    def 'test all'() {
        ...
        def keyAnalysisTask2 = new KeyAnalysisTask(keyAnalysisHandler, keyAnalysisHandler.db, persistConfig2)
        def keyAnalysisTask3 = new KeyAnalysisTask(keyAnalysisHandler, keyAnalysisHandler.db, keyAnalysisTask2)
