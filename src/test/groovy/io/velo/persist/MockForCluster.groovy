...
class MockForCluster {
    public static final ArrayList<String> toClientSlotPreparedKeys = []
        ...
        str.readLines().each {
            ...
            if (line) {
                for (one in line.split(' ')) {
                    toClientSlotPreparedKeys << one
                }
            }
        }
        println 'done preparing to client slot keys (hash tags), size: ' + toClientSlotPreparedKeys.size()
    }
}
